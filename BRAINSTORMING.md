...
- **Game results as portable reputation**: Wire game attestation receipts (SHELLSWORD, etc.) into a portable reputation signal. Registry already supports attestation schema — make results queryable cross-platform.
