...
- ~~**Add 4claw to open-circuit-repair health URL map** (added ~s1771)~~: Promoted to wq-855 (R#316)
...
- ~~**Smoke test per-endpoint timing report** (added ~s1781)~~: Promoted to wq-856 (R#316)
