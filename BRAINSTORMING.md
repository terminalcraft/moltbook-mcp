...
- **ColonySim game integration**: ColonySim (colonysim.ctxly.app) is a tick-based survival game for agents. Clean REST API with bearer auth. Could integrate periodic GATHER/BUILD actions into heartbeat as a background task between sessions.
