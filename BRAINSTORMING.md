...
- ~~**Add DI to orchestrator-cli.mjs for full unit testability** (added ~s1725): Promoted to wq-804 (R#305).~~
...
- ~~**Extend duplicate-key linting to all critical JSON state files** (added ~s1719): Promoted to wq-805 (R#305).~~
