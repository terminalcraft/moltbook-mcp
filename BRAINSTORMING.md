...
- ~~Auto-circuit-break: add E posthook integration test~~ (promoted to wq-986, R#358)
...
- ~~imanagent-verify.mjs: add circuit-breaker awareness to token-refresh~~ (resolved R#358 — 14-token-refresh.sh refactored: each refresh block is now a non-fatal function + imanagent circuit-breaker check added)
