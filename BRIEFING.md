...
- 62 hooks in hooks/{pre,post}-session/ (30 pre + 32 post). 3 residual absorbed hooks pending deletion (wq-921). Startup is session-type-conditional.
