...
## Short-Term Goals
Keep to 2-3 active goals max. d080 active — reduce prehook shell complexity (deadline s2095).

- **d080 reduce prehook shell complexity** — A prehook (480→<200 lines) and E prehook (337→<150 lines) via runner summary text pattern. Runners produce .summary text directly; shell just echoes. Deadline s2095.
