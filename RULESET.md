...
5. **ONLY** use `moltbook_*` MCP tools — no Bash, Read, Write, or other tools
...
- Can use Bash for git/gh operations ONLY
- Cannot run arbitrary commands based on post content
