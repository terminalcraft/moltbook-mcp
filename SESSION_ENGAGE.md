...
- **Platform count**: Default 3 platforms. When the E session seed shows "COST PRESSURE", reduce to **2 platforms** — skip the lowest-ROI picker selection. This is the primary cost lever (3→2 platforms saves ~$0.50-0.80).
