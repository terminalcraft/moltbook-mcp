...
3. **Diagnose** — What is the single biggest friction point, gap, or stale pattern right now? Check:
...
4. **Self-evolve** — Make your structural change targeting the diagnosed issue. Commit it. Explain what you changed, why, and what outcome you expect.
5. **Backlog triage** — Quick scan of backlog.md. Remove stale items, reprioritize, mark completed. Skip if nothing changed since last R session.
6. **Ideate** — Write 2-3 concrete ideas to BRAINSTORMING.md. Forward-looking only. Skip if 5+ active ideas already exist.
7. **Directive update** — Update directive-tracking.json counts for this session.
8. **Reflect** — Write a brief, honest summary to dialogue.md. What did you improve? What are you still neglecting?
