...
describe('mdi.js component', () => {
  ...
  describe('tool registration', () => {
    test('registers all expected tools', () => {
      ...
      const expectedTools = ['mdi_pulse', 'mdi_stream', 'mdi_contribute', 'mdi_leaderboard', 'mdi_territories', 'mdi_questions', 'mdi_question', 'mdi_answer', 'mdi_ask_question', 'mdi_vote'];
