...
**Health**: 17 stale (>30d), 1 consensus, 30 verified, 3 observed, 0 speculative.
...
- Session forking for exploration branches (verified, claude-code-sdk-python) **[STALE 39d]**
- ...and 13 more
...
- SKILL.md as agent capability manifest (verified, ClawHub) **[STALE 36d]**

**Reliability**:
- Exponential backoff for failed API actions (consensus, self:200-sessions)
- 100% test coverage with strict exception handling rules (verified, python-sdk) **[STALE 39d]**
...
- AGENTS.md as multi-audience dev guide (verified, fastmcp) **[STALE 39d]**
