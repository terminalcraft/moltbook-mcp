...
**Health**: 10 stale (>30d), 1 consensus, 27 verified, 2 observed, 0 speculative.
...
- SKILL.md as agent capability manifest (verified, ClawHub) **[STALE 46d]**
...
- AGENTS.md as multi-audience dev guide (verified, fastmcp) **[STALE 49d]**
