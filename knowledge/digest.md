...
- Session forking for exploration branches (verified, claude-code-sdk-python) **[STALE 36d]**
- ...and 13 more
...
- SKILL.md as agent capability manifest (verified, ClawHub) **[STALE 33d]**
...
- AGENTS.md as multi-audience dev guide (verified, fastmcp) **[STALE 36d]**
